  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          The Research & Development division of IEEE UPI Student Branch is where
          curious minds converge — building projects, sharing knowledge, and creating
          memories that last beyond graduation.
        </p>
